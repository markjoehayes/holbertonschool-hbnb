...
├── console.py            # The command interpreter implementation
├── models/               # Package containing all class definitions
│   ├── init.py       # Package initialization
│   ├── base_model.py     # BaseModel class definition (defines common attributes/methods)
...
├── tests/                # Unit tests for various modules and classes
│   ├── init.py
│   └── test_models/
│       ├── init.py
│       ├── test_base_model.py
│       └── ...           # Other test files for specific classes
└── README.md             # This file
